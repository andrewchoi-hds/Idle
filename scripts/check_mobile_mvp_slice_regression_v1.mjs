...
async function main() {
  ...
  checks.push({
    ...
    passed:
      buildOfflineDetailCompareInvalidTargetLabelKo() ===
        buildOfflineDetailCompareResultFallbackLabelKo("invalid_target") &&
      buildOfflineDetailCompareResultLabelKo(
        offlineDetailCompareCodeAll,
        "BAD",
      ) === buildOfflineDetailCompareInvalidTargetLabelKo(),
  ...
  checks.push({
    ...
    passed:
      buildOfflineDetailCompareMissingCurrentLabelKo() ===
        buildOfflineDetailCompareResultFallbackLabelKo("current_missing") &&
      buildOfflineDetailCompareResultLabelKo(
        "INVALID",
        offlineDetailCompareCodeAll,
      ) === buildOfflineDetailCompareMissingCurrentLabelKo(),
  ...
  checks.push({
    id: "offline_detail_compare_result_fallback_label_helper_is_stable",
    passed:
      buildOfflineDetailCompareResultFallbackLabelKo("target_missing") ===
        buildOfflineDetailCompareInvalidTargetLabelKo() &&
      buildOfflineDetailCompareResultFallbackLabelKo("current_missing") ===
        buildOfflineDetailCompareMissingCurrentLabelKo() &&
      buildOfflineDetailCompareResultFallbackLabelKo("invalid_target") ===
  ...
  checks.push({
    ...
    passed:
      buildOfflineDetailCompareResultPendingLabelKo() ===
        buildOfflineDetailCompareResultStateFallbackLabelKo("target_missing") &&
      buildOfflineDetailCompareResultStateLabelKo(
        offlineDetailCompareCodeAll,
        "",
      ) === buildOfflineDetailCompareResultPendingLabelKo(),
  ...
  checks.push({
    ...
    passed:
      buildOfflineDetailCompareResultInputRequiredLabelKo() ===
        buildOfflineDetailCompareResultStateFallbackLabelKo("invalid_target") &&
      buildOfflineDetailCompareResultStateLabelKo(
        offlineDetailCompareCodeAll,
        "invalid",
      ) === buildOfflineDetailCompareResultInputRequiredLabelKo(),
  ...
  checks.push({
    id: "offline_detail_compare_code_delta_summary_target_missing_message_label_is_stable",
    passed:
      buildOfflineDetailCompareCodeDeltaSummaryTargetMissingMessageLabelKo() ===
        "대상 코드 없음" &&
      buildOfflineDetailCompareCodeDeltaSummaryTargetMissingLabelKo().endsWith(
        buildOfflineDetailCompareCodeDeltaSummaryTargetMissingMessageLabelKo(),
      ) &&
      buildOfflineDetailCompareCodeDeltaSummaryLabelKo(
        offlineDetailCompareCodeAll,
        "",
      ).endsWith(buildOfflineDetailCompareCodeDeltaSummaryTargetMissingMessageLabelKo()),
  });
  ...
  checks.push({
    ...
    passed:
      buildOfflineDetailCompareCodeDeltaSummaryCriticalVisibleChangedLabelKo(5) ===
        `${buildOfflineDetailCompareCodeDeltaSummaryCriticalVisibleKeyLabelKo()} +5` &&
      buildOfflineDetailCompareCodeDeltaSummaryCriticalVisibleChangedLabelKo(-2) ===
        `${buildOfflineDetailCompareCodeDeltaSummaryCriticalVisibleKeyLabelKo()} -2` &&
      offlineDetailCompareCriticalVisibleMismatchDiff.comparable &&
      buildOfflineDetailCompareCodeDeltaSummaryLabelKo(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeCriticalVisibleMismatch,
  ...
  checks.push({
    id: "offline_detail_compare_code_delta_summary_critical_visible_key_label_is_stable",
    passed:
      buildOfflineDetailCompareCodeDeltaSummaryCriticalVisibleKeyLabelKo() ===
        "핵심표시" &&
      buildOfflineDetailCompareCodeDeltaSummaryCriticalVisibleChangedLabelKo(
  ...
  checks.push({
    id: "offline_detail_compare_code_delta_summary_view_mode_all_label_is_stable",
    passed:
      buildOfflineDetailCompareCodeDeltaSummaryViewModeAllLabelKo() === "전체" &&
      buildOfflineDetailCompareCodeDeltaSummaryViewModeChangedLabelKo(
        "all",
        "critical",
      ).includes(buildOfflineDetailCompareCodeDeltaSummaryViewModeAllLabelKo()) &&
      buildOfflineDetailCompareCodeDeltaSummaryViewModeChangedLabelKo(
        "critical",
        "all",
      ).includes(buildOfflineDetailCompareCodeDeltaSummaryViewModeAllLabelKo()),
  ...
  checks.push({
    ...
    passed:
      ...
      buildOfflineDetailCompareCodeDeltaSummaryLabelKo(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeCritical,
      ).includes(buildOfflineDetailCompareCodeDeltaSummaryViewChecksumChangedSuffixLabelKo()),
  });
  ...
  checks.push({
    ...
    passed:
      buildOfflineDetailCompareCodeDeltaSummaryCodeDifferenceLabelKo() ===
        `차이 요약: ${buildOfflineDetailCompareCodeDeltaSummaryCodeDifferenceMessageLabelKo()}` &&
      offlineDetailCompareCodeCanonicalVariant !== offlineDetailCompareCodeAll &&
      buildOfflineDetailCompareCodeDeltaSummaryLabelKo(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeCanonicalVariant,
  ...
  checks.push({
    id: "offline_detail_compare_code_delta_summary_code_difference_message_label_is_stable",
    passed:
      buildOfflineDetailCompareCodeDeltaSummaryCodeDifferenceMessageLabelKo() ===
        "코드 차이 감지" &&
      offlineDetailCompareCodeCanonicalVariant !== offlineDetailCompareCodeAll &&
      buildOfflineDetailCompareCodeDeltaSummaryCodeDifferenceLabelKo().endsWith(
        buildOfflineDetailCompareCodeDeltaSummaryCodeDifferenceMessageLabelKo(),
      ) &&
      buildOfflineDetailCompareCodeDeltaSummaryLabelKo(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeCanonicalVariant,
      ).endsWith(buildOfflineDetailCompareCodeDeltaSummaryCodeDifferenceMessageLabelKo()),
  });
  ...
  checks.push({
    ...
    passed:
      ...
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptors()
        ...
        ["info", "error", "warn"].join("|") &&
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptors()
        .map((descriptor) => descriptor.resultLabelKo)
        .join("|") ===
        [
          buildOfflineDetailCompareInvalidTargetLabelKo(),
          buildOfflineDetailCompareMissingCurrentLabelKo(),
      ...
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptors()
        .map((descriptor) => descriptor.resultStateLabelKo)
        .join("|") ===
        [
          buildOfflineDetailCompareResultPendingLabelKo(),
          buildOfflineDetailCompareMissingCurrentLabelKo(),
      ...
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptors()
        .map((descriptor) => descriptor.resultStateTone)
        .join("|") ===
        ["info", "error", "warn"].join("|") &&
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptors()
      ...
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptor("target_missing")
        .resultLabelKo === buildOfflineDetailCompareInvalidTargetLabelKo() &&
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptor("current_missing")
        .resultLabelKo === buildOfflineDetailCompareMissingCurrentLabelKo() &&
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptor("invalid_target")
        .resultLabelKo === buildOfflineDetailCompareInvalidTargetLabelKo() &&
      buildOfflineDetailCompareCodeMatchSummaryFallbackDescriptor("target_missing")
  ...
  checks.push({
    id: "offline_detail_compare_code_match_summary_current_missing_message_label_is_stable",
    passed:
      buildOfflineDetailCompareCodeMatchSummaryCurrentMissingMessageLabelKo() ===
        "현재 코드 없음" &&
      buildOfflineDetailCompareCodeMatchSummaryCurrentMissingLabelKo().endsWith(
        buildOfflineDetailCompareCodeMatchSummaryCurrentMissingMessageLabelKo(),
      ) &&
      buildOfflineDetailCompareCodeMatchSummaryLabelKo(
        "INVALID",
        offlineDetailCompareCodeAll,
      ).endsWith(buildOfflineDetailCompareCodeMatchSummaryCurrentMissingMessageLabelKo()),
  });
  ...
  checks.push({
    id: "offline_detail_compare_code_match_summary_item_result_label_formatter_is_stable",
    passed:
      buildOfflineDetailCompareCodeMatchSummaryItemResultLabelKo(
        buildOfflineDetailCompareCodeMatchSummaryTotalKeyLabelKo(),
        true,
  ...
  checks.push({
    id: "offline_detail_compare_code_match_summary_critical_visible_key_label_is_stable",
    passed:
      buildOfflineDetailCompareCodeMatchSummaryCriticalVisibleKeyLabelKo() === "핵심표시" &&
      buildOfflineDetailCompareCodeMatchSummaryLabelKo(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeAll,
      ).includes(
  ...
  checks.push({
    id: "offline_detail_compare_code_match_summary_mismatched_label_is_stable",
    passed:
      buildOfflineDetailCompareCodeMatchSummaryMismatchedLabelKo() === "불일치" &&
      buildOfflineDetailCompareCodeMatchSummaryLabelKo(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeCritical,
      ).includes(`보기 ${buildOfflineDetailCompareCodeMatchSummaryMismatchedLabelKo()}`) &&
      buildOfflineDetailCompareCodeMatchSummaryLabelKo(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeCritical,
      ).includes(
  ...
  checks.push({
    id: "offline_detail_compare_result_state_fallback_helpers_are_stable",
    passed:
      buildOfflineDetailCompareResultStateFallbackLabelKo("target_missing") ===
        buildOfflineDetailCompareResultPendingLabelKo() &&
      buildOfflineDetailCompareResultStateFallbackLabelKo("current_missing") ===
        buildOfflineDetailCompareMissingCurrentLabelKo() &&
      buildOfflineDetailCompareResultStateFallbackLabelKo("invalid_target") ===
        buildOfflineDetailCompareResultInputRequiredLabelKo() &&
      buildOfflineDetailCompareResultStateFallbackLabelKo("unknown") ===
        buildOfflineDetailCompareResultInputRequiredLabelKo() &&
      buildOfflineDetailCompareResultStateFallbackTone("target_missing") === "info" &&
      buildOfflineDetailCompareResultStateFallbackTone("current_missing") === "error" &&
      buildOfflineDetailCompareResultStateFallbackTone("invalid_target") === "warn" &&
      buildOfflineDetailCompareResultStateFallbackTone("unknown") === "warn",
  });
  ...
  checks.push({
    ...
    passed:
      buildOfflineDetailCompareResultStateTone(offlineDetailCompareCodeAll, "") ===
        buildOfflineDetailCompareResultStateFallbackTone("target_missing") &&
      buildOfflineDetailCompareResultStateTone(offlineDetailCompareCodeAll, "invalid") ===
        buildOfflineDetailCompareResultStateFallbackTone("invalid_target") &&
      buildOfflineDetailCompareResultStateTone(
        offlineDetailCompareCodeAll,
        offlineDetailCompareCodeAll,
      ) ===
