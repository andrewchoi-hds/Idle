...
const REQUIRED_HTML_IDS = [
  ...
  "btnCollectionTabJournal",
  "guardianCollectionTab",
  "guardianOwnedSummary",
...
async function main() {
  ...
  assertIncludes(
    html,
    'id="btnOpsDigestPresetBattle"',
    "index.html",
    failures,
  );
  assertIncludes(
    html,
    'id="btnOpsDigestPresetSave"',
    "index.html",
    failures,
  );
  assertIncludes(
  ...
  assertIncludes(
    html,
    'data-filter-battle-label="전투 흐름"',
    "index.html",
    failures,
  );
  assertIncludes(
    html,
    'data-filter-battle-active="false"',
    "index.html",
    failures,
  );
  assertIncludes(
    html,
    'data-filter-save-label="저장 흐름"',
    "index.html",
    failures,
  );
  assertIncludes(
    html,
    'data-filter-save-active="false"',
    "index.html",
    failures,
  );
  assertIncludes(
  ...
  assertIncludes(
    html,
    'data-timeline-collapsed-preview-depth="2"',
    "index.html",
    failures,
  );
  assertIncludes(
  ...
  assertIncludes(css, ".ops-digest-item[data-card-section-start=\"true\"][data-card-section-role=\"lead\"] {", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"lead\"] .ops-digest-card-priority,", "app.css", failures);
  assertIncludes(css, "filter: saturate(1.04) brightness(1.03);", "app.css", failures);
  ...
  assertIncludes(css, "box-shadow: 0 0 0 1px rgba(10, 17, 16, 0.28);", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"lead\"] {", "app.css", failures);
  assertIncludes(css, "box-shadow: 0 8px 18px rgba(10, 17, 16, 0.18);", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"lead\"][data-card-tone=\"warn\"] .ops-digest-card-meta", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"lead\"] .ops-digest-card-head", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-start=\"true\"][data-card-section-role=\"lead\"] .ops-digest-card-label", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"lead\"] .ops-digest-link", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"lead\"] .ops-digest-link-label", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"] .ops-digest-card-meta", "app.css", failures);
  assertIncludes(css, "box-shadow: inset 0 0 0 1px rgba(10, 17, 16, 0.16);", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"]::before", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"][data-card-tone=\"warn\"]::before", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"][data-card-tone=\"error\"]::before", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"] .ops-digest-card-head", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"] {", "app.css", failures);
  assertIncludes(css, "box-shadow: 0 4px 10px rgba(10, 17, 16, 0.12);", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"] .ops-digest-value", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"][data-card-tone=\"warn\"] .ops-digest-card-priority,", "app.css", failures);
  assertIncludes(css, ".ops-digest-item[data-card-section-role=\"peer\"][data-card-tone=\"error\"] .ops-digest-value", "app.css", failures);
