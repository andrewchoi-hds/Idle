...
- 전투 연출 패널:
  ...
  - 듀얼 HUD 수치와 연동된 상시 상태 데이터(`data-cast-tier`, `data-scene-pressure`, `data-scene-combo-tier`, `data-scene-lead`)를 추가하고, 아레나 루트 dataset(`data-scene-player-hp-tier`, `data-scene-player-cast-tier`, `data-scene-enemy-hp-tier`, `data-scene-enemy-cast-tier`, `data-scene-player-hp-pct`, `data-scene-player-cast-pct`, `data-scene-enemy-hp-pct`, `data-scene-enemy-cast-pct`)에도 배우 tier/퍼센트를 기록해 기세/연격/압력 변화가 배우·아레나 비주얼에 즉시 반영
