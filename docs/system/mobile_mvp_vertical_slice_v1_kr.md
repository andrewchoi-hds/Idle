...
```
  ...
  - qi progress contract(`qiProgressBar`)가 기본값에서 `data-qi-pct=0`, `data-qi-current=0`, `data-qi-required=0`, `data-breakthrough-ready=false`로 시작하고, `render()` 경로가 progress width와 dataset을 함께 갱신하는지 검증
